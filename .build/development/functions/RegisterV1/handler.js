...
exports.handler = function () {
  ...
  return _squeezerEventNode2.default.apply(undefined, [_vars2.default, function (req, res) {
    ...
    db.addUser(req.body).then(function (data) {
      return res.json(200, {
        message: 'success',
        data: data
      });
...
module.exports = {"name":"api-rest-nodejs","path":"/home/i0026/Projects/SQZapi","identifier":"ApiRestNodejs","stage":"local","config":{},"provider":"local","runtime":"nodejs","appBaseUrl":"http://localhost:4001","storageBaseUrl":"http://localhost:4001/.build","mongodb":{"uri":"mongodb://127.0.0.1/users","options":{"useMongoClient":true}},"response-http-headers":[{"Access-Control-Allow-Origin":"*"},{"Access-Control-Allow-Headers":"Authorization, Content-Type"}],"function":{"name":"registerV1","event":{"type":"http","path":"/v1/register","methods":["POST"]},"packaging":["vars.json"],"swagger":{"paths":{"/v1/register":{"post":{"summary":"Signup a user","description":"Add a user as a JSON object","tags":["User"],"produces":["application/json"],"parameters":[{"in":"body","name":"body","description":"Product object that needs to be added to the store","required":true,"schema":{"$ref":"#/definitions/User"}}],"responses":{"200":{"description":"successful operation","schema":{"$ref":"#/definitions/AddUserResponse"}},"400":{"description":"bad request","schema":{"$ref":"#/definitions/ErrorResponseV1"}},"500":{"description":"internal error"}}}}},"definitions":{"AddUserResponse":{"type":"object","properties":{"message":{"type":"string","default":"success"},"data":{"type":"object","$ref":"#/definitions/UserInf"}}},"UserInf":{"type":"object","properties":{"name":{"type":"string","default":""},"email":{"type":"string","default":""},"__id":{"type":"string","default":""},"__v":{"type":"integer","default":0}}}}},"handler":"handler","timeout":6,"memory":128,"identifier":"RegisterV1","service":"Users","serviceIdentifier":"Users","path":"/home/i0026/Projects/SQZapi/services/Users/register","packagePath":"/home/i0026/Projects/SQZapi/.build/deploy/functions","packageFile":"RegisterV1.zip","flagged":true,"force":false}}
      ...
      return new Promise(function (resolve, reject) {
        _this.db.init().then(function () {
          _User2.default.findOne({ email: item.email }, function (err, data) {
            if (err) return reject(err);else if (data) return reject("user already exist");else {
              item.password = bcrypt.hashSync(item.password, 8);
              var user = new _User2.default(item);
